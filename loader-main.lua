...
local win = lib:Window("Wyvern X", "(v3.0 - Premium)", Color3.fromRGB(7, 32, 117), _G.closeBind) -- _G.closeBind is the bind to close the gui, kinda cool for a bind in your GUI
...
lib:Notification("Disclaimer: If you select an area, turn off your Auto-Farm before selecting, otherwise the script will break.", "Alright!") -- Example of a notification on the GUI (optional)


local areas = farmtab:Dropdown("Area to Farm", {"Mystic Mine", "Cyber Cavern", "Paradise Cave"}, function(areaa)
...
farmtab:Textbox("Farm Speed", "Changes the farming speed in seconds.", false, function(speed) -- true or false to toggle if the text disappears after typing in
...
farmtab:Toggle("Auto-Farm", "Automatically farms the best unlocked area of the Diamond Mine.", false, function(uwu) -- t can be anything, choose false or true for what is the value in default
